...
#define KEY_WORLD_1         ::KeyCode::World1        /* non-US #1 */
#define KEY_WORLD_2         ::KeyCode::World2        /* non-US #2 */
...
#define KEY_RIGHT_SHIFT     ::KeyCode::RightShift
#define KEY_RIGHT_CONTROL   ::KeyCode::RightControl
