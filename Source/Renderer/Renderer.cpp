...
void Renderer::Initialize(const FRendererInitializeParameters& params)
{
	...
	InitializeResourceHeaps();
	{
		...
		mStaticVertexBufferPool.Create(pDevice, EBufferType::VERTEX_BUFFER, STATIC_GEOMETRY_MEMORY_SIZE, USE_GPU_MEMORY, "Renderer::mStaticVertexBufferPool");
		mStaticIndexBufferPool .Create(pDevice, EBufferType::INDEX_BUFFER , STATIC_GEOMETRY_MEMORY_SIZE, USE_GPU_MEMORY, "Renderer::mStaticIndexBufferPool");
	}
...
void Renderer::InitializeResourceHeaps()
{
